  ...
  return (
    <div className='flex p-4 min-w-80 border-solid border-gray-900 border-b-2'>
      ...
      <div className='w-80'>
        ...
        <div className='flex text-gray-500 mt-1 cursor-default'>
          <div className='flex items-center'>
            <svg className='fill-current mr-1 w-5 h-5' viewBox='0 0 512 512'>
          ...
          <div className='flex items-center pl-5'>
            <svg className='fill-current mr-2 w-5 h-5' viewBox='0 0 512 512'>
